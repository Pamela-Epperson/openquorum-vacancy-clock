...
export const STATE_CONFIG = {
  ...
  PA: {
    ...
    applyLabel: "Governor Shapiro's Boards & Commissions Office",
  ...
  NY: {
    ...
    applyLabel: "Governor's Office — Contact for Board Appointments",
    dataSource: "governor.ny.gov",
    totalBoardsNote: "700+ boards statewide",
    contextNote: "New York's dedicated board appointment portal (governor.ny.gov/appointments) is currently offline with no announced replacement. Governor Hochul's office is actively making appointments — contact the Governor's office directly to express interest in a board seat.", auditNote: null,
    boards: [
  ...
  NC: {
    ...
    applyLabel: "NC Governor's Boards & Commissions — Apply",
  ...
  NJ: {
    ...
    applyLabel: "Governor Sherrill — Boards, Commissions & Authorities",
  ...
  IL: {
    ...
    applyUrl: "https://govappointments.illinois.gov/",
    applyLabel: "IL Governor's Office of Executive Appointments",
