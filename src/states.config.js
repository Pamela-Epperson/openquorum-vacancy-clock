...
export const STATE_CONFIG = {
  ...
  // ─── Pennsylvania ─────────────────────────────────────────────────────────────
  PA: {
    label: "Pennsylvania", region: "Mid-Atlantic",
    color: "#1B3A6B", bg: "#E6EEF8",
    applyUrl: "https://www.governor.pa.gov/appointment-information/",
    applyLabel: "Governor's Office — Appointments",
    dataSource: "governor.pa.gov",
  ...
  // ─── New York ─────────────────────────────────────────────────────────────────
  NY: {
    label: "New York", region: "Northeast",
    color: "#7B1E2E", bg: "#FAEDF0",
    applyUrl: "https://www.governor.ny.gov/appointments",
    applyLabel: "Governor's Appointments Office",
  ...
  // ─── North Carolina ───────────────────────────────────────────────────────────
  NC: {
    label: "North Carolina", region: "South",
    color: "#13294B", bg: "#E6EDF5",
    applyUrl: "https://appointments.nc.gov",
    applyLabel: "Governor's Office — Boards & Commissions",
    dataSource: "appointments.nc.gov",
  ...
  // ─── New Jersey ───────────────────────────────────────────────────────────────
  NJ: {
    label: "New Jersey", region: "Mid-Atlantic",
    color: "#1C3F6E", bg: "#E6EDF8",
    applyUrl: "https://www.nj.gov/governor/appointments/",
    applyLabel: "Governor's Appointments Portal",
    dataSource: "nj.gov/governor",
    totalBoardsNote: "500+ boards statewide",
    contextNote: "A new gubernatorial administration took office in January 2026, creating a fresh wave of appointment opportunities across New Jersey's boards and commissions as the incoming team fills transition vacancies.",
    auditNote: null,
    boards: [
  ...
  // ─── Georgia ──────────────────────────────────────────────────────────────────
  GA: {
    label: "Georgia", region: "South",
    color: "#BA0C2F", bg: "#FAEBEE",
    applyUrl: "https://gov.georgia.gov/appointments",
    applyLabel: "Governor's Office of Appointments",
    dataSource: "gov.georgia.gov",
    totalBoardsNote: "400+ boards statewide",
  ...
  // ─── Illinois ─────────────────────────────────────────────────────────────────
  IL: {
    label: "Illinois", region: "Midwest",
    color: "#003366", bg: "#E5EBF5",
    applyUrl: "https://appointments.illinois.gov",
    applyLabel: "Governor's Office of Executive Appointments",
    dataSource: "appointments.illinois.gov",
    totalBoardsNote: "600+ boards statewide",
    contextNote: null,
...
export const STATE_TEMPLATE = {
  label:"", region:"", color:"", bg:"",
  applyUrl:"", applyLabel:"", dataSource:"",
