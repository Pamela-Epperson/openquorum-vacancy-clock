...
export const STATE_CONFIG = {
  ...
  CA: {
    ...
    scraper:{ endpoint:"https://www.gov.ca.gov/join-the-administration/government-appointments/", lastPulled:"2026-08-19T16:35:40.918Z", selectorProfile:"ca" },
  ...
  // ─── Iowa ─── status: live (scraper: manual) ───
  IA: {
    code:"IA", label:"Iowa", region:"Midwest",
    status:"live",
    color:"#7A3E8F", bg:"#F4EBF7",
    applyUrl:"https://governor.iowa.gov/",
    applyAuthority:"Governor's Office",
    applyLabel:"Governor's Office",
    applyVerified:"2026-08-20",
    dataSource:"Iowa Code / Governor's appointments",
    scraper:{ endpoint:null, lastPulled:"2026-08-19T00:00:00.000Z", selectorProfile:"manual" },
    totalBoardsNote:"Hand-verified statute-cited seed · no central vacancy list · 2 verified of 2 openings tracked",
    ...
    auditNote:null,
    boards:[
      {"id":59401,"name":"Iowa Board of Medicine","domain":"health","totalSeats":10,"vacantSeats":0,"vacantSince":null,"authority":"Governor's Office","constituent":"Iowa patients & licensed physicians","applyUrl":"https://governor.iowa.gov/","sourceUrl":"https://www.legis.iowa.gov/docs/code/147.14.pdf","lastVerified":"2026-08-19","mandate":"Licenses and disciplines Iowa's physicians. Ten members appointed by the Governor with Senate confirmation — five physicians, two osteopathic physicians, and three public members (Iowa Code 147.14 / 148).","seatSource":"https://www.legis.iowa.gov/docs/code/147.14.pdf","criticalNote":"Curated from the Iowa Code; IA's new IAppoint vacancy system is JS-rendered (inventory mode)","populationServed":3190369,"populationSource":"https://www.census.gov/quickfacts/IA","requires":["Health Policy","Program & Project Management","Research & Analysis"],"confirmation":false},
      {"id":59402,"name":"Iowa Natural Resource Commission","domain":"environment","totalSeats":7,"vacantSeats":0,"vacantSince":null,"authority":"Governor's Office","constituent":"Iowa hunters, anglers, parks & wildlife","applyUrl":"https://governor.iowa.gov/","sourceUrl":"https://www.legis.iowa.gov/docs/ico/chapter/456A.pdf","lastVerified":"2026-08-19","mandate":"Sets policy for Iowa's fish, wildlife, parks, and land management under the DNR. Seven members appointed by the Governor with Senate confirmation, balanced by party and geography (Iowa Code 455A.5).","seatSource":"https://www.legis.iowa.gov/docs/ico/chapter/456A.pdf","criticalNote":"Curated from the Iowa Code; IA's new IAppoint vacancy system is JS-rendered (inventory mode)","populationServed":3190369,"populationSource":"https://www.census.gov/quickfacts/IA","requires":["Environmental Policy","Research & Analysis","Policy"],"confirmation":false}
    ]
  },



  // ─── Idaho ─── status: live (scraper: manual) ───
  ID: {
    code:"ID", label:"Idaho", region:"West",
    status:"live",
    color:"#7A3E8F", bg:"#F4EBF7",
    ...
    scraper:{ endpoint:null, lastPulled:"2026-08-19T00:00:00.000Z", selectorProfile:"manual" },
    totalBoardsNote:"Hand-verified statute-cited seed · no central vacancy list · 3 verified of 3 openings tracked",
    ...
    auditNote:null,
    boards:[
      {"id":59501,"name":"Idaho State Board of Pharmacy","domain":"health","totalSeats":7,"vacantSeats":0,"vacantSince":null,"authority":"Governor's Office","constituent":"Idaho patients & licensed pharmacists · drug safety","applyUrl":"https://gov.idaho.gov/boards-and-commissions/","sourceUrl":"https://law.justia.com/codes/idaho/title-54/chapter-17/section-54-1706/","lastVerified":"2026-08-19","mandate":"Licenses pharmacists and regulates pharmacy practice in Idaho. Seven members appointed by the Governor — five licensed pharmacists, one certified pharmacy technician, and one public member (Idaho Code 54-1706).","seatSource":"https://law.justia.com/codes/idaho/title-54/chapter-17/section-54-1706/","criticalNote":"Curated from the Idaho Code; ID publishes no central board-vacancy list (inventory mode)","populationServed":1839106,"populationSource":"https://www.census.gov/quickfacts/ID","requires":["Health Policy","Program & Project Management","Research & Analysis"],"confirmation":false},
      {"id":59502,"name":"Idaho Real Estate Commission","domain":"housing","totalSeats":4,"vacantSeats":0,"vacantSince":null,"authority":"Governor's Office","constituent":"Idaho home buyers & licensed brokers","applyUrl":"https://gov.idaho.gov/boards-and-commissions/","sourceUrl":"https://law.justia.com/codes/idaho/title-54/chapter-20/","lastVerified":"2026-08-19","mandate":"Licenses and regulates Idaho's real estate brokers and salespersons. Four members appointed by the Governor, one from each of the state's four districts, each an actively licensed broker (Idaho Code 54-2005).","seatSource":"https://law.justia.com/codes/idaho/title-54/chapter-20/","criticalNote":"Curated from the Idaho Code; ID publishes no central board-vacancy list (inventory mode)","populationServed":1839106,"populationSource":"https://www.census.gov/quickfacts/ID","requires":["Housing Policy","Program & Project Management","Policy"],"confirmation":false},
      {"id":59503,"name":"Idaho Fish and Game Commission","domain":"environment","totalSeats":7,"vacantSeats":0,"vacantSince":null,"authority":"Governor's Office","constituent":"Idaho hunters, anglers & wildlife","applyUrl":"https://gov.idaho.gov/boards-and-commissions/","sourceUrl":"https://legislature.idaho.gov/statutesrules/idstat/title36/t36ch1/sect36-102/","lastVerified":"2026-08-19","mandate":"Sets policy for Idaho's wildlife and the Department of Fish and Game. Seven commissioners appointed by the Governor with Senate confirmation, one per region, no more than four from one party (Idaho Code 36-102).","seatSource":"https://legislature.idaho.gov/statutesrules/idstat/title36/t36ch1/sect36-102/","criticalNote":"Curated from the Idaho Code; ID publishes no central board-vacancy list (inventory mode)","populationServed":1839106,"populationSource":"https://www.census.gov/quickfacts/ID","requires":["Environmental Policy","Research & Analysis","Policy"],"confirmation":false}
    ]
  },



  // ─── Maine ─── status: live (scraper: manual) ───
  ME: {
    code:"ME", label:"Maine", region:"Northeast",
    status:"live",
    color:"#7A3E8F", bg:"#F4EBF7",
    ...
    auditNote:null,
    boards:[
      {"id":60001,"name":"Maine Board of Licensure in Medicine","domain":"health","totalSeats":11,"vacantSeats":0,"vacantSince":null,"authority":"Governor's Office","constituent":"Maine patients & licensed physicians","applyUrl":"https://www.maine.gov/governor/","sourceUrl":"https://legislature.maine.gov/statutes/32/title32sec3263.html","lastVerified":"2026-08-19","mandate":"Licenses and disciplines Maine's physicians and physician assistants. Eleven members appointed by the Governor — six physicians, two physician assistants, and three public members (32 M.R.S. 3263).","seatSource":"https://legislature.maine.gov/statutes/32/title32sec3263.html","criticalNote":"Curated from the Maine Revised Statutes; ME publishes no central board-vacancy list (inventory mode)","populationServed":1362359,"populationSource":"https://www.census.gov/quickfacts/ME","requires":["Health Policy","Program & Project Management","Research & Analysis"],"confirmation":false},
      {"id":60002,"name":"Maine Real Estate Commission","domain":"housing","totalSeats":6,"vacantSeats":0,"vacantSince":null,"authority":"Governor's Office","constituent":"Maine home buyers & licensed brokers","applyUrl":"https://www.maine.gov/governor/","sourceUrl":"https://www.mainelegislature.org/legis/statutes/32/title32sec13062.html","lastVerified":"2026-08-19","mandate":"Licenses and regulates Maine's real estate brokers and salespersons. Six members appointed by the Governor — four industry members and two public members (32 M.R.S. 13062).","seatSource":"https://www.mainelegislature.org/legis/statutes/32/title32sec13062.html","criticalNote":"Curated from the Maine Revised Statutes; ME publishes no central board-vacancy list (inventory mode)","populationServed":1362359,"populationSource":"https://www.census.gov/quickfacts/ME","requires":["Housing Policy","Program & Project Management","Policy"],"confirmation":false}
    ]
  },



  // ─── Montana ─── status: live (scraper: manual) ───
  MT: {
    code:"MT", label:"Montana", region:"West",
    status:"live",
    color:"#7A3E8F", bg:"#F4EBF7",
    ...
    auditNote:null,
    boards:[
      {"id":60401,"name":"Montana Board of Realty Regulation","domain":"housing","totalSeats":7,"vacantSeats":0,"vacantSince":null,"authority":"Governor's Office","constituent":"Montana home buyers & licensed brokers","applyUrl":"https://governor.mt.gov/","sourceUrl":"https://law.justia.com/codes/montana/title-2/chapter-15/part-17/section-2-15-1757/","lastVerified":"2026-08-19","mandate":"Licenses and regulates Montana's real estate brokers, salespersons, and property managers. Seven members appointed by the Governor with Senate consent — five licensees and two public members (MCA 2-15-1757).","seatSource":"https://law.justia.com/codes/montana/title-2/chapter-15/part-17/section-2-15-1757/","criticalNote":"Curated from the Montana Code; MT publishes no central board-vacancy list (inventory mode)","populationServed":1084225,"populationSource":"https://www.census.gov/quickfacts/MT","requires":["Housing Policy","Program & Project Management","Policy"],"confirmation":false},
      {"id":60402,"name":"Montana Fish and Wildlife Commission","domain":"environment","totalSeats":7,"vacantSeats":0,"vacantSince":null,"authority":"Governor's Office","constituent":"Montana hunters, anglers & wildlife","applyUrl":"https://governor.mt.gov/","sourceUrl":"https://law.justia.com/codes/montana/title-2/chapter-15/part-34/section-2-15-3402/","lastVerified":"2026-08-19","mandate":"Sets policy for Montana's wildlife, fisheries, and state parks. Seven commissioners appointed by the Governor with Senate confirmation, one per department region (MCA 2-15-3402).","seatSource":"https://law.justia.com/codes/montana/title-2/chapter-15/part-34/section-2-15-3402/","criticalNote":"Curated from the Montana Code; MT publishes no central board-vacancy list (inventory mode)","populationServed":1084225,"populationSource":"https://www.census.gov/quickfacts/MT","requires":["Environmental Policy","Research & Analysis","Policy"],"confirmation":false}
    ]
  },



  // ─── North Dakota ─── status: live (scraper: manual) ───
  ND: {
    code:"ND", label:"North Dakota", region:"Midwest",
    status:"live",
    color:"#8A5A0B", bg:"#FAF1DE",
    ...
    auditNote:null,
    boards:[
      {"id":60501,"name":"North Dakota State Board of Medical Examiners","domain":"health","totalSeats":13,"vacantSeats":0,"vacantSince":null,"authority":"Governor's Office","constituent":"North Dakota patients & licensed physicians","applyUrl":"https://www.governor.nd.gov/","sourceUrl":"https://ndlegis.gov/cencode/t43c17.pdf","lastVerified":"2026-08-19","mandate":"Licenses and disciplines North Dakota's physicians and physician assistants. Thirteen members appointed by the Governor — nine MDs, one DO, one physician assistant, and two public members (N.D.C.C. 43-17).","seatSource":"https://ndlegis.gov/cencode/t43c17.pdf","criticalNote":"Curated from the North Dakota Century Code; ND publishes no central board-vacancy list (inventory mode)","populationServed":779094,"populationSource":"https://www.census.gov/quickfacts/ND","requires":["Health Policy","Program & Project Management","Research & Analysis"],"confirmation":false},
      {"id":60502,"name":"North Dakota State Real Estate Commission","domain":"housing","totalSeats":5,"vacantSeats":0,"vacantSince":null,"authority":"Governor's Office","constituent":"North Dakota home buyers & licensed brokers","applyUrl":"https://www.governor.nd.gov/","sourceUrl":"https://ndlegis.gov/cencode/t43c23.pdf","lastVerified":"2026-08-19","mandate":"Licenses and regulates North Dakota's real estate brokers and salespersons. Five members appointed by the Governor, three of whom must be active real estate brokers (N.D.C.C. 43-23-01).","seatSource":"https://ndlegis.gov/cencode/t43c23.pdf","criticalNote":"Curated from the North Dakota Century Code; ND publishes no central board-vacancy list (inventory mode)","populationServed":779094,"populationSource":"https://www.census.gov/quickfacts/ND","requires":["Housing Policy","Program & Project Management","Policy"],"confirmation":false}
    ]
  },



  // ─── Nebraska ─── status: live (scraper: manual) ───
  NE: {
    code:"NE", label:"Nebraska", region:"Midwest",
    status:"live",
    color:"#8A5A0B", bg:"#FAF1DE",
    ...
    auditNote:null,
    boards:[
      {"id":60601,"name":"Nebraska Real Estate Commission","domain":"housing","totalSeats":6,"vacantSeats":0,"vacantSince":null,"authority":"Governor's Office","constituent":"Nebraska home buyers & licensed brokers","applyUrl":"https://governor.nebraska.gov/","sourceUrl":"https://nebraskalegislature.gov/laws/statutes.php?statute=81-885.02","lastVerified":"2026-08-19","mandate":"Licenses and regulates Nebraska's real estate brokers and salespersons. Six members appointed by the Governor — three district brokers plus a public member, a salesperson, and an at-large broker (Neb. Rev. Stat. 81-885.02).","seatSource":"https://nebraskalegislature.gov/laws/statutes.php?statute=81-885.02","criticalNote":"Curated from the Nebraska Statutes; NE publishes no central board-vacancy list (inventory mode)","populationServed":1961504,"populationSource":"https://www.census.gov/quickfacts/NE","requires":["Housing Policy","Program & Project Management","Policy"],"confirmation":false},
      {"id":60602,"name":"Nebraska Game and Parks Commission","domain":"environment","totalSeats":9,"vacantSeats":0,"vacantSince":null,"authority":"Governor's Office","constituent":"Nebraska hunters, anglers & state parks","applyUrl":"https://governor.nebraska.gov/","sourceUrl":"https://nebraskalegislature.gov/laws/statutes.php?statute=37-101","lastVerified":"2026-08-19","mandate":"Sets policy for Nebraska's wildlife, fisheries, and state parks. Nine commissioners appointed by the Governor with legislative consent — one from each of eight districts plus one at large (Neb. Rev. Stat. 37-101).","seatSource":"https://nebraskalegislature.gov/laws/statutes.php?statute=37-101","criticalNote":"Curated from the Nebraska Statutes; NE publishes no central board-vacancy list (inventory mode)","populationServed":1961504,"populationSource":"https://www.census.gov/quickfacts/NE","requires":["Environmental Policy","Research & Analysis","Policy"],"confirmation":false},
      {"id":60603,"name":"Nebraska Power Review Board","domain":"environment","totalSeats":5,"vacantSeats":0,"vacantSince":null,"authority":"Governor's Office","constituent":"Nebraska public-power ratepayers & utilities","applyUrl":"https://governor.nebraska.gov/","sourceUrl":"https://nebraskalegislature.gov/laws/statutes.php?statute=70-1003","lastVerified":"2026-08-19","mandate":"Regulates the structure of Nebraska's public-power system and approves major electric projects. Five members appointed by the Governor — at least one engineer and one attorney (Neb. Rev. Stat. 70-1003).","seatSource":"https://nebraskalegislature.gov/laws/statutes.php?statute=70-1003","criticalNote":"Curated from the Nebraska Statutes; NE publishes no central board-vacancy list (inventory mode)","populationServed":1961504,"populationSource":"https://www.census.gov/quickfacts/NE","requires":["Environmental Policy","Research & Analysis","Policy"],"confirmation":false}
    ]
  },



  // ─── New Hampshire ─── status: live (scraper: manual) ───
  NH: {
    code:"NH", label:"New Hampshire", region:"Northeast",
    status:"live",
    color:"#8A5A0B", bg:"#FAF1DE",
    applyUrl:"https://www.governor.nh.gov/",
    applyAuthority:"Governor & Executive Council",
    applyLabel:"Governor & Executive Council",
    applyVerified:"2026-08-20",
    ...
    auditNote:null,
    boards:[
      {"id":60701,"name":"New Hampshire Fish and Game Commission","domain":"environment","totalSeats":11,"vacantSeats":0,"vacantSince":null,"authority":"Governor & Executive Council","constituent":"New Hampshire hunters, anglers & wildlife","applyUrl":"https://www.governor.nh.gov/","sourceUrl":"https://www.gencourt.state.nh.us/rsa/html/XVIII/206/206-2.htm","lastVerified":"2026-08-19","mandate":"Sets policy for New Hampshire's fish and wildlife. Eleven members appointed by the Governor with Executive Council consent, one from each county and tidewater (RSA 206:2).","seatSource":"https://www.gencourt.state.nh.us/rsa/html/XVIII/206/206-2.htm","criticalNote":"Curated from the New Hampshire Revised Statutes; NH publishes no central board-vacancy list (inventory mode)","populationServed":1377529,"populationSource":"https://www.census.gov/quickfacts/NH","requires":["Environmental Policy","Research & Analysis","Policy"],"confirmation":false},
      {"id":60702,"name":"New Hampshire Real Estate Commission","domain":"housing","totalSeats":5,"vacantSeats":0,"vacantSince":null,"authority":"Governor & Executive Council","constituent":"New Hampshire home buyers & licensed brokers","applyUrl":"https://www.governor.nh.gov/","sourceUrl":"https://law.justia.com/codes/new-hampshire/title-xxx/chapter-331-a/section-331-a-5/","lastVerified":"2026-08-19","mandate":"Licenses and regulates New Hampshire's real estate brokers and salespersons. Five members appointed by the Governor with Executive Council consent — two brokers, a salesperson, a lawyer, and a public member (RSA 331-A:5).","seatSource":"https://law.justia.com/codes/new-hampshire/title-xxx/chapter-331-a/section-331-a-5/","criticalNote":"Curated from the New Hampshire Revised Statutes; NH publishes no central board-vacancy list (inventory mode)","populationServed":1377529,"populationSource":"https://www.census.gov/quickfacts/NH","requires":["Housing Policy","Program & Project Management","Policy"],"confirmation":false}
    ]
  },



  // ─── Rhode Island ─── status: live (scraper: manual) ───
  RI: {
    code:"RI", label:"Rhode Island", region:"Northeast",
    status:"live",
    color:"#8A5A0B", bg:"#FAF1DE",
    ...
    auditNote:null,
    boards:[
      {"id":61301,"name":"Rhode Island Real Estate Commission","domain":"housing","totalSeats":11,"vacantSeats":0,"vacantSince":null,"authority":"Governor's Office","constituent":"Rhode Island home buyers & licensed brokers","applyUrl":"https://governor.ri.gov/","sourceUrl":"https://law.justia.com/codes/rhode-island/2018/title-5/chapter-5-20.5/section-5-20.5-12/","lastVerified":"2026-08-19","mandate":"Licenses and regulates Rhode Island's real estate brokers and salespersons. Nine members appointed by the Governor plus the Attorney General and department director ex officio (R.I. Gen. Laws 5-20.5-12).","seatSource":"https://law.justia.com/codes/rhode-island/2018/title-5/chapter-5-20.5/section-5-20.5-12/","criticalNote":"9 of 11 seats are governor-appointed (Attorney General and department director serve ex officio)","populationServed":1097379,"populationSource":"https://www.census.gov/quickfacts/RI","requires":["Housing Policy","Program & Project Management","Policy"],"confirmation":false},
      {"id":61302,"name":"Rhode Island Board of Medical Licensure and Discipline","domain":"health","totalSeats":11,"vacantSeats":0,"vacantSince":null,"authority":"Governor's Office","constituent":"Rhode Island patients & licensed physicians","applyUrl":"https://governor.ri.gov/","sourceUrl":"https://law.justia.com/codes/rhode-island/title-5/chapter-5-37/","lastVerified":"2026-08-19","mandate":"Licenses and disciplines Rhode Island's physicians. Eleven members appointed by the Governor — four MDs, two DOs, and five public members (R.I. Gen. Laws 5-37-1.1).","seatSource":"https://law.justia.com/codes/rhode-island/title-5/chapter-5-37/","criticalNote":"Curated from the Rhode Island General Laws; RI publishes no central board-vacancy list (inventory mode)","populationServed":1097379,"populationSource":"https://www.census.gov/quickfacts/RI","requires":["Health Policy","Program & Project Management","Research & Analysis"],"confirmation":false}
    ]
  },



  // ─── Utah ─── status: live (scraper: manual) ───
  UT: {
    code:"UT", label:"Utah", region:"West",
    status:"live",
    color:"#7A3E8F", bg:"#F4EBF7",
    ...
    auditNote:null,
    boards:[
      {"id":61801,"name":"Utah Real Estate Commission","domain":"housing","totalSeats":5,"vacantSeats":0,"vacantSince":null,"authority":"Governor's Office","constituent":"Utah home buyers & licensed brokers","applyUrl":"https://governor.utah.gov/","sourceUrl":"https://le.utah.gov/xcode/Title61/Chapter2f/61-2f-S103.html","lastVerified":"2026-08-19","mandate":"Licenses and regulates Utah's real estate brokers and sales agents. Five members appointed by the Governor with Senate consent — four licensees and one public member (Utah Code 61-2f-103).","seatSource":"https://le.utah.gov/xcode/Title61/Chapter2f/61-2f-S103.html","criticalNote":"Curated from the Utah Code; UT publishes no central board-vacancy list (inventory mode)","populationServed":3271616,"populationSource":"https://www.census.gov/quickfacts/UT","requires":["Housing Policy","Program & Project Management","Policy"],"confirmation":false},
      {"id":61802,"name":"Utah Wildlife Board","domain":"environment","totalSeats":7,"vacantSeats":0,"vacantSince":null,"authority":"Governor's Office","constituent":"Utah hunters, anglers & wildlife","applyUrl":"https://governor.utah.gov/","sourceUrl":"https://le.utah.gov/xcode/Title23A/23A.html","lastVerified":"2026-08-19","mandate":"Sets policy and rules for Utah's wildlife and the Division of Wildlife Resources. Seven members appointed by the Governor with Senate consent, representing wildlife, habitat, business, and economics expertise across regions (Utah Code 23A-2-301).","seatSource":"https://le.utah.gov/xcode/Title23A/23A.html","criticalNote":"Curated from the Utah Code; UT publishes no central board-vacancy list (inventory mode)","populationServed":3271616,"populationSource":"https://www.census.gov/quickfacts/UT","requires":["Environmental Policy","Research & Analysis","Policy"],"confirmation":false},
      {"id":61803,"name":"Utah Physicians Licensing Board","domain":"health","totalSeats":15,"vacantSeats":0,"vacantSince":null,"authority":"Governor's Office","constituent":"Utah patients & licensed physicians","applyUrl":"https://governor.utah.gov/","sourceUrl":"https://le.utah.gov/xcode/Title58/Chapter67/58-67-S201.html","lastVerified":"2026-08-19","mandate":"Advises on licensing and discipline of Utah's physicians and physician assistants. Fifteen members appointed by the Governor — seven MDs, two DOs, a psychiatrist, three physician assistants, and two public members (Utah Code 58-67-201).","seatSource":"https://le.utah.gov/xcode/Title58/Chapter67/58-67-S201.html","criticalNote":"Curated from the Utah Code; UT publishes no central board-vacancy list (inventory mode)","populationServed":3271616,"populationSource":"https://www.census.gov/quickfacts/UT","requires":["Health Policy","Program & Project Management","Research & Analysis"],"confirmation":false}
    ]
  },



  // ─── West Virginia ─── status: live (scraper: manual) ───
  WV: {
    code:"WV", label:"West Virginia", region:"South",
    status:"live",
    color:"#2F6B9A", bg:"#E8F1F8",
    applyUrl:"https://governor.wv.gov/",
    applyAuthority:"Governor's Boards & Commissions",
    applyLabel:"Governor's Boards & Commissions",
    applyVerified:"2026-08-20",
    dataSource:"West Virginia Code / Governor's Boards & Commissions",
    scraper:{ endpoint:null, lastPulled:"2026-08-19T00:00:00.000Z", selectorProfile:"manual" },
    totalBoardsNote:"Hand-verified statute-cited seed · no central vacancy list · 5 verified of 5 openings tracked",
    ...
    auditNote:null,
    boards:[
      {"id":62201,"name":"West Virginia Board of Medicine","domain":"health","totalSeats":15,"vacantSeats":0,"vacantSince":null,"authority":"Governor's Office — Boards & Commissions","constituent":"West Virginia patients & licensed physicians","applyUrl":"https://governor.wv.gov/","sourceUrl":"https://code.wvlegislature.gov/30-3-5/","lastVerified":"2026-08-19","mandate":"Licenses and disciplines West Virginia's physicians and podiatrists. Fifteen members — fourteen appointed by the Governor with Senate consent plus the State Health Officer ex officio (W. Va. Code 30-3-5).","seatSource":"https://code.wvlegislature.gov/30-3-5/","criticalNote":"14 of 15 seats are governor-appointed (State Health Officer serves ex officio)","populationServed":1793716,"populationSource":"https://www.census.gov/quickfacts/WV","requires":["Health Policy","Program & Project Management","Research & Analysis"],"confirmation":false},
      {"id":62202,"name":"West Virginia Board of Examiners for Registered Professional Nurses","domain":"health","totalSeats":7,"vacantSeats":0,"vacantSince":null,"authority":"Governor's Office — Boards & Commissions","constituent":"West Virginia patients & registered nurses","applyUrl":"https://governor.wv.gov/","sourceUrl":"https://code.wvlegislature.gov/30-7-3/","lastVerified":"2026-08-19","mandate":"Licenses and regulates West Virginia's registered professional nurses. Seven members appointed by the Governor with Senate consent — an APRN, a dialysis technician, four registered nurses, and one citizen member (W. Va. Code 30-7-3).","seatSource":"https://code.wvlegislature.gov/30-7-3/","criticalNote":"Curated from the West Virginia Code; WV publishes no central board-vacancy list (inventory mode)","populationServed":1793716,"populationSource":"https://www.census.gov/quickfacts/WV","requires":["Health Policy","Program & Project Management","Research & Analysis"],"confirmation":false},
      {"id":62203,"name":"West Virginia Board of Pharmacy","domain":"health","totalSeats":7,"vacantSeats":0,"vacantSince":null,"authority":"Governor's Office — Boards & Commissions","constituent":"West Virginia patients & licensed pharmacists · drug safety","applyUrl":"https://governor.wv.gov/","sourceUrl":"https://code.wvlegislature.gov/30-5-5/","lastVerified":"2026-08-19","mandate":"Licenses pharmacists and regulates pharmacy practice in West Virginia. Seven members appointed by the Governor with Senate consent — five licensed pharmacists and two citizen members (W. Va. Code 30-5-5).","seatSource":"https://code.wvlegislature.gov/30-5-5/","criticalNote":"Curated from the West Virginia Code; WV publishes no central board-vacancy list (inventory mode)","populationServed":1793716,"populationSource":"https://www.census.gov/quickfacts/WV","requires":["Health Policy","Program & Project Management","Research & Analysis"],"confirmation":false},
      {"id":62204,"name":"West Virginia Real Estate Commission","domain":"housing","totalSeats":5,"vacantSeats":0,"vacantSince":null,"authority":"Governor's Office — Boards & Commissions","constituent":"West Virginia home buyers & licensed brokers","applyUrl":"https://governor.wv.gov/","sourceUrl":"https://code.wvlegislature.gov/30-40-6/","lastVerified":"2026-08-19","mandate":"Licenses and regulates West Virginia's real estate brokers and salespersons. Five members appointed by the Governor with Senate consent — four licensees and one citizen member (W. Va. Code 30-40-6).","seatSource":"https://code.wvlegislature.gov/30-40-6/","criticalNote":"Curated from the West Virginia Code; WV publishes no central board-vacancy list (inventory mode)","populationServed":1793716,"populationSource":"https://www.census.gov/quickfacts/WV","requires":["Housing Policy","Program & Project Management","Policy"],"confirmation":false},
      {"id":62205,"name":"West Virginia Natural Resources Commission","domain":"environment","totalSeats":7,"vacantSeats":0,"vacantSince":null,"authority":"Governor's Office — Boards & Commissions","constituent":"West Virginia hunters, anglers & wildlife","applyUrl":"https://governor.wv.gov/","sourceUrl":"https://code.wvlegislature.gov/20-1-16/","lastVerified":"2026-08-19","mandate":"Sets policy for West Virginia's wildlife, parks, and natural resources. Seven commissioners appointed by the Governor with Senate consent, one per DNR district and the rest at large (W. Va. Code 20-1-16).","seatSource":"https://code.wvlegislature.gov/20-1-16/","criticalNote":"Curated from the West Virginia Code; WV publishes no central board-vacancy list (inventory mode)","populationServed":1793716,"populationSource":"https://www.census.gov/quickfacts/WV","requires":["Environmental Policy","Research & Analysis","Policy"],"confirmation":false}
    ]
  },



  // ─── Alaska ─── status: live (scraper: manual) ───
  AK: {
    code:"AK", label:"Alaska", region:"West",
    status:"live",
    color:"#7A3E8F", bg:"#F4EBF7",
    ...
    scraper:{ endpoint:null, lastPulled:"2026-08-20T00:00:00.000Z", selectorProfile:"manual" },
    totalBoardsNote:"Hand-verified statute-cited seed · no central vacancy list · 3 verified of 3 openings tracked",
    ...
    auditNote:null,
    boards:[
      {"id":58501,"name":"Alaska State Medical Board","domain":"health","totalSeats":8,"vacantSeats":0,"vacantSince":null,"authority":"Governor's Office","constituent":"Alaska patients & licensed physicians","applyUrl":"https://gov.alaska.gov/","sourceUrl":"https://law.justia.com/codes/alaska/title-8/chapter-64/article-1/section-08-64-010/","lastVerified":"2026-08-20","mandate":"Licenses and disciplines Alaska's physicians and physician assistants. Eight members appointed by the Governor — five physicians from separate regions, a physician assistant, and two public members (AS 08.64.010).","seatSource":"https://law.justia.com/codes/alaska/title-8/chapter-64/article-1/section-08-64-010/","criticalNote":"Curated from the Alaska Statutes; AK publishes no central board-vacancy list (inventory mode)","populationServed":733391,"populationSource":"https://www.census.gov/quickfacts/AK","requires":["Health Policy","Program & Project Management","Research & Analysis"],"confirmation":false},
      {"id":58502,"name":"Alaska Board of Game","domain":"environment","totalSeats":7,"vacantSeats":0,"vacantSince":null,"authority":"Governor's Office","constituent":"Alaska hunters, anglers & wildlife","applyUrl":"https://gov.alaska.gov/","sourceUrl":"https://law.justia.com/codes/alaska/title-16/","lastVerified":"2026-08-20","mandate":"Sets Alaska's hunting and trapping regulations and wildlife conservation policy. Seven members appointed by the Governor and confirmed by the Legislature, chosen for diversity of interest (AS 16.05.221).","seatSource":"https://law.justia.com/codes/alaska/title-16/","criticalNote":"Curated from the Alaska Statutes; AK publishes no central board-vacancy list (inventory mode)","populationServed":733391,"populationSource":"https://www.census.gov/quickfacts/AK","requires":["Environmental Policy","Research & Analysis","Policy"],"confirmation":false},
      {"id":58503,"name":"Alaska Real Estate Commission","domain":"housing","totalSeats":7,"vacantSeats":0,"vacantSince":null,"authority":"Governor's Office","constituent":"Alaska home buyers & licensed brokers","applyUrl":"https://gov.alaska.gov/","sourceUrl":"https://law.justia.com/codes/alaska/title-8/chapter-88/article-1/","lastVerified":"2026-08-20","mandate":"Licenses and regulates Alaska's real estate brokers and licensees. Seven members appointed by the Governor — five brokers across the judicial districts and two public members (AS 08.88.011).","seatSource":"https://law.justia.com/codes/alaska/title-8/chapter-88/article-1/","criticalNote":"Curated from the Alaska Statutes; AK publishes no central board-vacancy list (inventory mode)","populationServed":733391,"populationSource":"https://www.census.gov/quickfacts/AK","requires":["Housing Policy","Program & Project Management","Policy"],"confirmation":false}
    ]
  },

  // ─── Hawaii ─── status: live (scraper: manual) ───
  HI: {
    code:"HI", label:"Hawaii", region:"West",
    status:"live",
    color:"#0E6B5C", bg:"#E0F4F0",
    ...
    auditNote:null,
    boards:[
      {"id":59301,"name":"Hawaii Medical Board","domain":"health","totalSeats":11,"vacantSeats":0,"vacantSince":null,"authority":"Governor's Office","constituent":"Hawaii patients & licensed physicians","applyUrl":"https://governor.hawaii.gov/","sourceUrl":"https://law.justia.com/codes/hawaii/title-25/chapter-453/section-453-5/","lastVerified":"2026-08-20","mandate":"Licenses and disciplines Hawaii's physicians and osteopathic physicians. Eleven members appointed by the Governor — seven physicians, two osteopathic physicians, and two public members, spread across the counties (HRS 453-5).","seatSource":"https://law.justia.com/codes/hawaii/title-25/chapter-453/section-453-5/","criticalNote":"Curated from the Hawaii Revised Statutes; HI publishes no central board-vacancy list (inventory mode)","populationServed":1455271,"populationSource":"https://www.census.gov/quickfacts/HI","requires":["Health Policy","Program & Project Management","Research & Analysis"],"confirmation":false},
      {"id":59302,"name":"Hawaii Board of Land and Natural Resources","domain":"environment","totalSeats":7,"vacantSeats":0,"vacantSince":null,"authority":"Governor's Office","constituent":"Hawaii hunters, anglers & wildlife","applyUrl":"https://governor.hawaii.gov/","sourceUrl":"https://law.justia.com/codes/hawaii/title-12/chapter-171/section-171-4/","lastVerified":"2026-08-20","mandate":"Governs Hawaii's public lands, water, forests, aquatic resources, and historic sites. Seven members appointed by the Governor with Senate consent — one per land district and three at large (HRS 171-4).","seatSource":"https://law.justia.com/codes/hawaii/title-12/chapter-171/section-171-4/","criticalNote":"Curated from the Hawaii Revised Statutes; HI publishes no central board-vacancy list (inventory mode)","populationServed":1455271,"populationSource":"https://www.census.gov/quickfacts/HI","requires":["Environmental Policy","Research & Analysis","Policy"],"confirmation":false},
      {"id":59303,"name":"Hawaii Real Estate Commission","domain":"housing","totalSeats":9,"vacantSeats":0,"vacantSince":null,"authority":"Governor's Office","constituent":"Hawaii home buyers & licensed brokers","applyUrl":"https://governor.hawaii.gov/","sourceUrl":"https://law.justia.com/codes/hawaii/title-25/chapter-467/section-467-3/","lastVerified":"2026-08-20","mandate":"Licenses and regulates Hawaii's real estate brokers and salespersons. Nine members appointed by the Governor — at least four licensed brokers, two public members, spread across the counties (HRS 467-3).","seatSource":"https://law.justia.com/codes/hawaii/title-25/chapter-467/section-467-3/","criticalNote":"Curated from the Hawaii Revised Statutes; HI publishes no central board-vacancy list (inventory mode)","populationServed":1455271,"populationSource":"https://www.census.gov/quickfacts/HI","requires":["Housing Policy","Program & Project Management","Policy"],"confirmation":false}
    ]
  },

  // ─── South Dakota ─── status: live (scraper: manual) ───
  SD: {
    code:"SD", label:"South Dakota", region:"Midwest",
    status:"live",
    color:"#2F6B9A", bg:"#E8F1F8",
    ...
    auditNote:null,
    boards:[
      {"id":61501,"name":"South Dakota Game, Fish and Parks Commission","domain":"environment","totalSeats":8,"vacantSeats":0,"vacantSince":null,"authority":"Governor's Office","constituent":"South Dakota hunters, anglers & wildlife","applyUrl":"https://governor.sd.gov/","sourceUrl":"https://law.justia.com/codes/south-dakota/title-41/chapter-02/","lastVerified":"2026-08-20","mandate":"Sets policy for South Dakota's wildlife, fisheries, and state parks. Eight members appointed by the Governor with Senate consent, balanced east/west-river and by party (SDCL 41-2-1).","seatSource":"https://law.justia.com/codes/south-dakota/title-41/chapter-02/","criticalNote":"Curated from the South Dakota Codified Laws; SD publishes no central board-vacancy list (inventory mode)","populationServed":886667,"populationSource":"https://www.census.gov/quickfacts/SD","requires":["Environmental Policy","Research & Analysis","Policy"],"confirmation":false},
      {"id":61502,"name":"South Dakota Real Estate Commission","domain":"housing","totalSeats":5,"vacantSeats":0,"vacantSince":null,"authority":"Governor's Office","constituent":"South Dakota home buyers & licensed brokers","applyUrl":"https://governor.sd.gov/","sourceUrl":"https://law.justia.com/codes/south-dakota/title-36/chapter-21a/section-36-21a-13/","lastVerified":"2026-08-20","mandate":"Licenses and regulates South Dakota's real estate brokers and salespersons. Five members appointed by the Governor — three active brokers and two public members (SDCL 36-21A-13).","seatSource":"https://law.justia.com/codes/south-dakota/title-36/chapter-21a/section-36-21a-13/","criticalNote":"Curated from the South Dakota Codified Laws; SD publishes no central board-vacancy list (inventory mode)","populationServed":886667,"populationSource":"https://www.census.gov/quickfacts/SD","requires":["Housing Policy","Program & Project Management","Policy"],"confirmation":false}
    ]
  },

  // ─── Vermont ─── status: live (scraper: manual) ───
  VT: {
    code:"VT", label:"Vermont", region:"Northeast",
    status:"live",
    color:"#8A5A0B", bg:"#FAF1DE",
    ...
    auditNote:null,
    boards:[
      {"id":61901,"name":"Vermont Board of Medical Practice","domain":"health","totalSeats":17,"vacantSeats":0,"vacantSince":null,"authority":"Governor's Office","constituent":"Vermont patients & licensed physicians","applyUrl":"https://governor.vermont.gov/","sourceUrl":"https://law.justia.com/codes/vermont/title-26/chapter-23/section-1351/","lastVerified":"2026-08-20","mandate":"Licenses and disciplines Vermont's physicians, physician assistants, and podiatrists. Seventeen members appointed by the Governor with Senate consent — nine physicians, a PA, a podiatrist, and six public members (26 V.S.A. 1351).","seatSource":"https://law.justia.com/codes/vermont/title-26/chapter-23/section-1351/","criticalNote":"Curated from the Vermont Statutes; VT publishes no central board-vacancy list (inventory mode)","populationServed":643077,"populationSource":"https://www.census.gov/quickfacts/VT","requires":["Health Policy","Program & Project Management","Research & Analysis"],"confirmation":false},
      {"id":61902,"name":"Vermont Fish and Wildlife Board","domain":"environment","totalSeats":14,"vacantSeats":0,"vacantSince":null,"authority":"Governor's Office","constituent":"Vermont hunters, anglers & wildlife","applyUrl":"https://governor.vermont.gov/","sourceUrl":"https://law.justia.com/codes/vermont/title-10/chapter-103/section-4041/","lastVerified":"2026-08-20","mandate":"Sets hunting, fishing, and trapping rules for Vermont's fish and wildlife. Fourteen members appointed by the Governor with Senate consent, one from each county (10 V.S.A. 4041).","seatSource":"https://law.justia.com/codes/vermont/title-10/chapter-103/section-4041/","criticalNote":"Curated from the Vermont Statutes; VT publishes no central board-vacancy list (inventory mode)","populationServed":643077,"populationSource":"https://www.census.gov/quickfacts/VT","requires":["Environmental Policy","Research & Analysis","Policy"],"confirmation":false}
    ]
  },

  // ─── Wyoming ─── status: live (scraper: manual) ───
  WY: {
    code:"WY", label:"Wyoming", region:"West",
    status:"live",
    color:"#2F6B9A", bg:"#E8F1F8",
    ...
    auditNote:null,
    boards:[
      {"id":62301,"name":"Wyoming Board of Medicine","domain":"health","totalSeats":8,"vacantSeats":0,"vacantSince":null,"authority":"Governor's Office","constituent":"Wyoming patients & licensed physicians","applyUrl":"https://governor.wyo.gov/","sourceUrl":"https://law.justia.com/codes/wyoming/title-33/chapter-26/article-2/section-33-26-201/","lastVerified":"2026-08-20","mandate":"Licenses and disciplines Wyoming's physicians and physician assistants. Eight members appointed by the Governor with Senate consent — five physicians, a physician assistant, and two lay members (Wyo. Stat. 33-26-201).","seatSource":"https://law.justia.com/codes/wyoming/title-33/chapter-26/article-2/section-33-26-201/","criticalNote":"Curated from the Wyoming Statutes; WY publishes no central board-vacancy list (inventory mode)","populationServed":576851,"populationSource":"https://www.census.gov/quickfacts/WY","requires":["Health Policy","Program & Project Management","Research & Analysis"],"confirmation":false},
      {"id":62302,"name":"Wyoming Game and Fish Commission","domain":"environment","totalSeats":7,"vacantSeats":0,"vacantSince":null,"authority":"Governor's Office","constituent":"Wyoming hunters, anglers & wildlife","applyUrl":"https://governor.wyo.gov/","sourceUrl":"https://law.justia.com/codes/wyoming/title-23/chapter-1/article-2/section-23-1-201/","lastVerified":"2026-08-20","mandate":"Sets policy for Wyoming's wildlife and the Game and Fish Department. Seven commissioners appointed by the Governor with Senate consent (the Governor also serves ex officio), each knowledgeable in wildlife management (Wyo. Stat. 23-1-201).","seatSource":"https://law.justia.com/codes/wyoming/title-23/chapter-1/article-2/section-23-1-201/","criticalNote":"Seven governor-appointed voting commissioners; the Governor serves ex officio","populationServed":576851,"populationSource":"https://www.census.gov/quickfacts/WY","requires":["Environmental Policy","Research & Analysis","Policy"],"confirmation":false},
      {"id":62303,"name":"Wyoming Real Estate Commission","domain":"housing","totalSeats":5,"vacantSeats":0,"vacantSince":null,"authority":"Governor's Office","constituent":"Wyoming home buyers & licensed brokers","applyUrl":"https://governor.wyo.gov/","sourceUrl":"https://law.justia.com/codes/wyoming/title-33/chapter-28/","lastVerified":"2026-08-20","mandate":"Licenses and regulates Wyoming's real estate brokers and salespersons. Five commissioners appointed by the Governor with Senate consent, no more than one per county (Wyo. Stat. 33-28-105).","seatSource":"https://law.justia.com/codes/wyoming/title-33/chapter-28/","criticalNote":"Curated from the Wyoming Statutes; WY publishes no central board-vacancy list (inventory mode)","populationServed":576851,"populationSource":"https://www.census.gov/quickfacts/WY","requires":["Housing Policy","Program & Project Management","Policy"],"confirmation":false}
    ]
  },
